                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="text-primary mb-0">Form Data Customer</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('sales.customer_add') }}" class="form-horizontal">
                        {{ csrf_field() }}
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="id_sales" id="id_sales" class="custom-select" placeholder="-- Pilih Sales --">
                                        <option value="{{ Auth::guard('sales')->user()->id_sales }}">{{ Auth::guard('sales')->user()->nama_sales }}</option>
                                    </select>
                                </div>
