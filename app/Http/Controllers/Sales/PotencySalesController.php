...
class PotencySalesController extends Controller
{
    /**
    ...
    public function json()
    {
		...
		$potencies = DB::table('potencies')->JOIN('offices','potencies.id_kantor','=','offices.id_kantor')
                                            ...
                                            ->JOIN('sbu_names','potencies.id_sbu','=','sbu_names.id_sbu')->where('customers.id_sales','=',$id_sales)
	...
	public function index(Request $request)
	{
		...
		return view('pages.sales.potensi');
	}
    ...
    public function import(Request $request)
    {
        ...
        // import data
        Excel::import(new PotencyImport, public_path('/file_potensi/'.$nama_file));

        // notifikasi dengan session
        Session::flash('sukses','Data Potensi Berhasil Diimport!');

        // alihkan halaman kembali
        return redirect('/sales/potensi');
    }
	...
	public function createStepOne(Request $request)
    {
		...
		$sales = Sales::all();
		$customers = Customers::where('customers.id_sales','=',$id_sales)->get()->sortBy('nama_pelanggan');
		$services = Services::all()->sortBy('segmen_service');
		$offices = Offices::all();
		$sbunames = SbuNames::all();

        $potencies = $request->session()->get('potencies');
        return view('pages.sales.create-step-one',compact('potencies','sales','customers','services','offices','sbunames', $potencies));
    }
    ...
    public function postCreateStepOne(Request $request)
    {
        ...
        return redirect()->route('sales.create.step.two');
    }
    ...
    public function createStepTwo(Request $request)
    {
        $sbunames = SbuNames::all();
        $potencies = $request->session()->get('potencies');
        return view('pages.sales.create-step-two',compact('potencies','sbunames', $potencies));
    }
    ...
    public function postCreateStepTwo(Request $request)
    {
        ...
        $potencies->fill($validatedData);
        $request->session()->put('potencies', $potencies);
        return redirect()->route('sales.create.step.three');
    }
    ...
    {
        $potencies = $request->session()->get('potencies');
        return view('pages.sales.create-step-three',compact('potencies', $potencies));
    }
    ...
    public function postCreateStepThree(Request $request)
    {
        ...
        $potencies->fill($validatedData);
        $request->session()->put('potencies', $potencies);
        return redirect()->route('sales.create.step.four');
    }
    ...
    public function createStepFour(Request $request)
    {
        ...
        return view('pages.sales.create-step-four',compact('potencies', $potencies),['nego' => $nego,'quote' => $quote,'po' => $po]);
    }
    ...
    public function postCreateStepFour(Request $request)
    {
        ...
        $potencies->fill($validatedData);
        $request->session()->put('potencies', $potencies);
        return redirect()->route('sales.create.step.five');
    }
    ...
    public function createStepFive(Request $request)
    {
        ...
        return view('pages.sales.create-step-five',compact('potencies', $potencies),['nama_sales' => $nama_sales,'nama_service' => $nama_service,'nama_sbu' => $nama_sbu]);
    }
    ...
    public function postCreateStepFive(Request $request)
    {
        ...
        $potencies->save();
        $request->session()->forget('potencies');
        Session::flash('sales_potensi_add','Data Potensi Berhasil Ditambah');
        return redirect()->route('sales.potensi');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.sales.edit_potensi',['potencies' => $potencies]);
    }
    ...
    Session::flash('sales_potensi_edit','Data Potensi Berhasil Diedit');    
