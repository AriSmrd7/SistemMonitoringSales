...
class HomeSalesController extends Controller
{
    ...
    public function index()
    {
        ...
        $total_customers = DB::table('customers')->where('id_sales','=',$id_sales)->count();  

        $date = \Carbon\Carbon::now();
        $current_month = $date->month;
        $last_month = $date->subMonth()->month;

        $total_revenue = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->whereMONTH('target_quote','=',$current_month)->where('id_sales','=',$id_sales)->sum('revenue_formula');
        $total_revenue_last = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->whereMONTH('target_quote','=',$last_month)->where('id_sales','=',$id_sales)->sum('revenue_formula');
...
if($total_revenue_last > 0){
    ...
    $kenaikan = 100;
        ...
        $total_potensi = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('update_action_plan','=','CLOSING')->whereMONTH('target_po','=',$current_month)->where('id_sales','=',$id_sales)->count();
        $total_potensi_last = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('update_action_plan','=','CLOSING')->whereMONTH('target_po','=',$last_month)->where('id_sales','=',$id_sales)->count();
...
if($total_potensi_last > 0){
    ...
    $kenaikan_potensi = 100;
       ...
       $segmen = DB::table('customers')->select(DB::raw('jenis_pelanggan as segmen'),DB::raw('count(id_pelanggan) as `total`'))->where('id_sales','=',$id_sales)->groupby('segmen')->get()->toArray();
        $nama_segmen = array_column($segmen, 'segmen');
        $total_segmen = array_column($segmen, 'total');

        $segmen = DB::table('customers')->select(DB::raw('jenis_pelanggan as segmen'),DB::raw('count(id_pelanggan) as `total`'))->groupby('segmen')->where('id_sales','=',$id_sales)->get();
        ...
        return view('pages.sales.dashboard',['total_customers' =>$total_customers,'kenaikan' => $kenaikan,'kenaikan_potensi' => $kenaikan_potensi,'total_revenue' => $total_revenue ,'total_potensi' => $total_potensi,'nama_segmen' => $nama_segmen,'total_segmen' => $total_segmen,'segmen' => $segmen,'tahun' => $tahun])->with($data1);;
    }
...
if($tahun == 'all'){  
              if ($action == 'Potensi') {
             $potensi = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->select('update_action_plan',DB::raw('count(*) as `total`'))->where('id_sales','=',$id_sales)->groupby('update_action_plan')->get()->toArray();
        }elseif ($action == 'Revenue') {
             $potensi = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->select('update_action_plan',DB::raw('sum(revenue_formula) as `total`'))->where('id_sales','=',$id_sales)->groupby('update_action_plan')->get()->toArray();            
        }
}else{
            if ($action == 'Potensi') {
             $potensi = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->select('update_action_plan',DB::raw('count(*) as `total`'))->where('id_sales','=',$id_sales)->whereYear('target_quote','=', $tahun)->groupby('update_action_plan')->get()->toArray();
        }elseif ($action == 'Revenue') {
             $potensi = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->select('update_action_plan',DB::raw('sum(revenue_formula) as `total`'))->where('id_sales','=',$id_sales)->whereYear('target_quote','=', $tahun)->groupby('update_action_plan')->get()->toArray();            
        }
}
 ...
 if($tahun == 'all'){
                if ($action == 'Potensi') {        
        $potensi = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->select('update_action_plan',DB::raw('count(*) as `total`'))->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->groupby('update_action_plan')->get()->toArray();
         }elseif ($action == 'Revenue') {
        $potensi = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->select('update_action_plan',DB::raw('sum(revenue_formula) as `total`'))->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->groupby('update_action_plan')->get()->toArray();
         }
 }
 else{
            if ($action == 'Potensi') {        
        $potensi = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->select('update_action_plan',DB::raw('count(*) as `total`'))->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereYear('target_quote','=', $tahun)->groupby('update_action_plan')->get()->toArray();
         }elseif ($action == 'Revenue') {
        $potensi = DB::table('potencies')->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->select('update_action_plan',DB::raw('sum(revenue_formula) as `total`'))->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereYear('target_quote','=', $tahun)->groupby('update_action_plan')->get()->toArray();
         }
 }       
    ...
    public function fetch_potency_month_sales(Request $request){
        ...
        if ($jenis == 'Quote') {
                $jan = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '01')->whereYear('target_quote','=', $tahun)->count();
                $feb = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '02')->whereYear('target_quote','=', $tahun)->count();
                $mar = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '03')->whereYear('target_quote','=', $tahun)->count();
                $apr = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '04')->whereYear('target_quote','=', $tahun)->count();
                $mei = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '05')->whereYear('target_quote','=', $tahun)->count();
                $jun = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '06')->whereYear('target_quote','=', $tahun)->count();
                $jul = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '07')->whereYear('target_quote','=', $tahun)->count();
                $agu = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '08')->whereYear('target_quote','=', $tahun)->count();
                $sep = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '09')->whereYear('target_quote','=', $tahun)->count();
                $okt = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '10')->whereYear('target_quote','=', $tahun)->count();
                $nov = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '11')->whereYear('target_quote','=', $tahun)->count();
                $des = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_quote','=', '12')->whereYear('target_quote','=', $tahun)->count();

                $rjan = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '01')->whereYear('real_quote','=', $tahun)->count();
                $rfeb = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '02')->whereYear('real_quote','=', $tahun)->count();
                $rmar = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '03')->whereYear('real_quote','=', $tahun)->count();
                $rapr = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '04')->whereYear('real_quote','=', $tahun)->count();
                $rmei = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '05')->whereYear('real_quote','=', $tahun)->count();
                $rjun = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '06')->whereYear('real_quote','=', $tahun)->count();
                $rjul = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '07')->whereYear('real_quote','=', $tahun)->count();
                $ragu = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '08')->whereYear('real_quote','=', $tahun)->count();
                $rsep = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '09')->whereYear('real_quote','=', $tahun)->count();
                $rokt = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '10')->whereYear('real_quote','=', $tahun)->count();
                $rnov = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '11')->whereYear('real_quote','=', $tahun)->count();
                $rdes = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_quote','=', '12')->whereYear('real_quote','=', $tahun)->count();
        }elseif ($jenis == 'Nego') {
                $jan = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '01')->whereYear('target_nego','=', $tahun)->count();
                $feb = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '02')->whereYear('target_nego','=', $tahun)->count();
                $mar = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '03')->whereYear('target_nego','=', $tahun)->count();
                $apr = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '04')->whereYear('target_nego','=', $tahun)->count();
                $mei = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '05')->whereYear('target_nego','=', $tahun)->count();
                $jun = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '06')->whereYear('target_nego','=', $tahun)->count();
                $jul = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '07')->whereYear('target_nego','=', $tahun)->count();
                $agu = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '08')->whereYear('target_nego','=', $tahun)->count();
                $sep = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '09')->whereYear('target_nego','=', $tahun)->count();
                $okt = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '10')->whereYear('target_nego','=', $tahun)->count();
                $nov = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '11')->whereYear('target_nego','=', $tahun)->count();
                $des = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_nego','=', '12')->whereYear('target_nego','=', $tahun)->count();

                $rjan = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '01')->whereYear('real_nego','=', $tahun)->count();
                $rfeb = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '02')->whereYear('real_nego','=', $tahun)->count();
                $rmar = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '03')->whereYear('real_nego','=', $tahun)->count();
                $rapr = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '04')->whereYear('real_nego','=', $tahun)->count();
                $rmei = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '05')->whereYear('real_nego','=', $tahun)->count();
                $rjun = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '06')->whereYear('real_nego','=', $tahun)->count();
                $rjul = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '07')->whereYear('real_nego','=', $tahun)->count();
                $ragu = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '08')->whereYear('real_nego','=', $tahun)->count();
                $rsep = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '09')->whereYear('real_nego','=', $tahun)->count();
                $rokt = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '10')->whereYear('real_nego','=', $tahun)->count();
                $rnov = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '11')->whereYear('real_nego','=', $tahun)->count();
                $rdes = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_nego','=', '12')->whereYear('real_nego','=', $tahun)->count();
        }elseif ($jenis == 'PO') {
                $jan = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '01')->whereYear('target_po','=', $tahun)->count();
                $feb = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '02')->whereYear('target_po','=', $tahun)->count();
                $mar = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '03')->whereYear('target_po','=', $tahun)->count();
                $apr = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '04')->whereYear('target_po','=', $tahun)->count();
                $mei = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '05')->whereYear('target_po','=', $tahun)->count();
                $jun = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '06')->whereYear('target_po','=', $tahun)->count();
                $jul = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '07')->whereYear('target_po','=', $tahun)->count();
                $agu = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '08')->whereYear('target_po','=', $tahun)->count();
                $sep = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '09')->whereYear('target_po','=', $tahun)->count();
                $okt = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '10')->whereYear('target_po','=', $tahun)->count();
                $nov = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '11')->whereYear('target_po','=', $tahun)->count();
                $des = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('target_po','=', '12')->whereYear('target_po','=', $tahun)->count();

                $rjan = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '01')->whereYear('real_po','=', $tahun)->count();
                $rfeb = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '02')->whereYear('real_po','=', $tahun)->count();
                $rmar = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '03')->whereYear('real_po','=', $tahun)->count();
                $rapr = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '04')->whereYear('real_po','=', $tahun)->count();
                $rmei = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '05')->whereYear('real_po','=', $tahun)->count();
                $rjun = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '06')->whereYear('real_po','=', $tahun)->count();
                $rjul = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '07')->whereYear('real_po','=', $tahun)->count();
                $ragu = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '08')->whereYear('real_po','=', $tahun)->count();
                $rsep = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '09')->whereYear('real_po','=', $tahun)->count();
                $rokt = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '10')->whereYear('real_po','=', $tahun)->count();
                $rnov = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '11')->whereYear('real_po','=', $tahun)->count();
                $rdes = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('jenis_pelanggan','=',$segmen)->where('id_sales','=',$id_sales)->whereMONTH('real_po','=', '12')->whereYear('real_po','=', $tahun)->count();
        }
        $a1 = [$jan,$feb,$mar,$apr,$mei,$jun,$jul,$agu,$sep,$okt,$nov,$des];
        $a2 = [$rjan,$rfeb,$rmar,$rapr,$rmei,$rjun,$rjul,$ragu,$rsep,$rokt,$rnov,$rdes];
        $response = [
    ...
    public function fetch_closing_segmen(Request $request)
    {
            ...
            $id_sales = Auth::guard('sales')->user()->id_sales;
                ...
                if($cek == 'Quote')
                {   $date = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
                                                        ->where('jenis_pelanggan','=',$jenis_pelanggan)
                                                        ->whereRAW('real_quote <= target_quote')
                                                        ->get()->count();
                    $date_10 = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
                                                        ->where('jenis_pelanggan','=',$jenis_pelanggan)
                                                        ->whereRAW('real_quote > target_quote')
                                                        ->whereRAW('real_quote <= DATE_ADD(target_quote, INTERVAL 10 DAY)')
                                                        ->get()->count();
                    $date_17 = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
                                                        ->where('jenis_pelanggan','=',$jenis_pelanggan)
                                                        ->whereRAW('real_quote >= DATE_ADD(target_quote, INTERVAL 11 DAY)')
                                                        ->whereRAW('real_quote <= DATE_ADD(target_quote, INTERVAL 17 DAY)')
                                                        ->get()->count();
                    $date_18 = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
                                                        ->where('jenis_pelanggan','=',$jenis_pelanggan)
                                                        ->whereRAW('real_quote >= DATE_ADD(target_quote, INTERVAL 18 DAY)')
                                                        ->whereRAW('real_quote <= DATE_ADD(target_quote, INTERVAL 22 DAY)')
                                                        ->get()->count();
                    $date_22 = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
                                                        ->where('jenis_pelanggan','=',$jenis_pelanggan)
                                                        ->whereRAW('real_quote > DATE_ADD(target_quote, INTERVAL 22 DAY)')
                                                        ->get()->count();

                    $datenull = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
                                                        ->where('jenis_pelanggan','=',$jenis_pelanggan)->wherenull('real_quote')->where('target_quote','>=',$newdate)->count();                        
                     $date10null = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
                                                        ->where('jenis_pelanggan','=',$jenis_pelanggan)->wherenull('real_quote')->where('target_quote','<',$newdate)
                                                        ->where(DB::raw('DATE_ADD(target_quote, INTERVAL 10 DAY)'),'>=',$newdate)
                                                        ->count();
                    $date17null = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
                                                        ->where('jenis_pelanggan','=',$jenis_pelanggan)->wherenull('real_quote')->where(DB::raw('DATE_ADD(target_quote, INTERVAL 11 DAY)'),'<=',$newdate)
                                                        ->where(DB::raw('DATE_ADD(target_quote, INTERVAL 17 DAY)'),'>=',$newdate)->count();
                    $date18null = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
                                                        ->where('jenis_pelanggan','=',$jenis_pelanggan)->wherenull('real_quote')->where(DB::raw('DATE_ADD(target_quote, INTERVAL 18 DAY)'),'<=',$newdate)
                                                        ->where(DB::raw('DATE_ADD(target_quote, INTERVAL 22 DAY)'),'>=',$newdate)->count();                                                                                                                                                                        
                    $date22null = DB::table('potencies')->select()->JOIN('customers','potencies.id_pelanggan','=','customers.id_pelanggan')->where('id_sales','=',$id_sales)
